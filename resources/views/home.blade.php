                ...
                <div class="card">
                    ...
                    <div class="card-body box-profile">
                        <div class="row">
                            ...
                            <div class="form-group col-6">
                                <label for="house_street">House No./ Street No./ Purok No. :</label>
                                <input id="house_street" name="house_street" value="{{auth()->user()->house_street}}" type="text" class="@error('house_street') is-invalid @enderror form-control" 
                                        placeholder="Enter house street" required>
                            </div>
                            <div class="form-group col-12">
                                <label for="contact">Contact Number :</label>
                                <input id="contact" name="contact" value="{{auth()->user()->contact}}" type="text" class="@error('contact') is-invalid @enderror form-control" 
